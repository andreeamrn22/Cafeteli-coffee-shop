...
import CoffeeCategorii from "../components/CoffeeProducts/CoffeeCategorii";
import Footer from "../components/Footer/Footer";
import ReusableHeader from "../components/ReusableHeader/ReusableHeader";
import poza from "../assets/website/background/boabe_cafea.jpg";
...
const CoffeeCategory = () => {
  ...
  return (
    <div>
      <Navbar />
      <ReusableHeader backgroundImage={poza} title="Cafea Boabe" />
      <CoffeeCategorii />
      <Footer />
      <motion.button
        onClick={scrollToTop}
