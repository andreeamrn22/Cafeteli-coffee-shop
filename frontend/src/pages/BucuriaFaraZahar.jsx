...
const products = [
  {
    image: meteorit_sana,
    name: "Meteorit SANA",
    href: "/produse/bucuria/fara_zahar/meteorit_sana",
  },
];

const BucuriaFaraZahar = () => {
  ...
  return (
    <div>
      <Navbar />
      <ReusableHeader backgroundImage={poza} title="Fără Zahăr" />
...
export default BucuriaFaraZahar;
