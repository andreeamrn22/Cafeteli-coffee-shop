...
import poza from "../assets/website/background/delicious-iced-coffee-arrangement.jpg";
import Footer from "../components/Footer/Footer";
import MeniuPage from "../components/Meniu/MeniuPage";
...
const Meniu = () => {
  ...
  return (
    <div>
      <Navbar />
      <ReusableHeader backgroundImage={poza} title="Meniu" />
      <MeniuPage />
      <Footer />
      <motion.button
        onClick={scrollToTop}
